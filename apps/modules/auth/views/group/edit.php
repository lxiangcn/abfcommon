...
<ol class="breadcrumb breadcrumb-no-padding">
	...
	<li>
		<a href="<?php echo site_url("auth/group/index");?>">用户组列表</a>
	</li>
	...
	<div class="panel-heading">
		<h3 class="panel-title">
			...
			<span class="small pull-right">
				<a href="<?php echo site_url("auth/group/index");?>">返回列表</a>
			</span>
		</h3>
	</div>
	<div class="panel-body">
		<form novalidate="novalidate" method="post" class="simple_form form-horizontal" action="<?php echo site_url('auth/group/edit/'.$id.'/'. $page_no  ); ?>" accept-charset="UTF-8">
