...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<?php echo form_open(site_url('dashboard/link/add/' . $page_no), 'id="validation-form" class="form-horizontal"'); ?>
		...
		<div class="form-group">
			<div class="col-md-offset-2 col-md-9">
				<button class="btn btn-primary" name="commit" type="submit">添加链接</button>
			</div>
		</div>
		<?php echo form_close();?>
	</div>
