...
<title><?php echo $title ? $title: $config['site_name']; ?></title>
...
<div id="navigation" class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo base_url();?>">手机模板layout</a>
		</div>
		...
		<div class="navbar-collapse collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				<li>
					<a href="<?php echo site_url('user/logout'); ?>">登录</a>
				</li>
				<li>
