...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form novalidate="novalidate" method="post" class="simple_form form-horizontal" action="<?php echo site_url('auth/member/edit/' . $data->id . '/' . $page_no); ?>" accept-charset="UTF-8">
