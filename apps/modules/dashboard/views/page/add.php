...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<?php echo form_open(site_url('dashboard/page/add/' . $page_no), 'id="validation-form" class="form-horizontal"'); ?>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<div class="radio">
					<label>
						<input class="px" type="radio" name="published" id="published_1" value="1" checked="checked" />
						<span class="lbl">显示</span>
					</label>
				</div>
				<div class="radio">
					<label>
						<input class="px" type="radio" name="published" id="published_0" value="0" />
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input type='text' class='form-control' name='keywords' id="keywords" value="<?php echo set_value('keywords'); ?>" />
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<textarea class="form-control" name="description" rows="2" cols="20" id="description"><?php echo set_value('description'); ?></textarea>
		...
		<div class="form-group">
			...
			<div class="col-md-10">
				<?php echo load_editor(); ?>
			</div>
		</div>
		<div class="form-group">
			<div class="col-md-offset-2 col-md-9">
				<button class="btn btn-primary" name="commit" type="submit">添加单页面</button>
			</div>
		</div>
		<?php echo form_close();?>
	</div>
