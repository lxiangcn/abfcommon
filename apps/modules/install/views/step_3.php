...
<div class="form-group">
	...
	<div class="col-md-7">
        <?php echo form_input(array('name' => 'site_name', 'id' => 'site_name', 'value' => set_value('site_name'), 'class' => "form-control", "placeholder" => "abfcommon")); ?>
    </div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-7">
        <?php echo form_input(array('name' => 'database', 'id' => 'database', 'value' => set_value('database', 'abfcommon'), 'class' => "form-control")); ?>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-7">
        <?php echo form_input(array('name' => 'prefix', 'id' => 'prefix', 'value' => set_value('prefix', "abf_"), 'class' => "form-control")); ?>
    </div>
</div>
