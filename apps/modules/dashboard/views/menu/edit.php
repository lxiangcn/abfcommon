...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input type='text' class='form-control' name='name' id="name" value="<?php echo set_value('name') == "" ? $data->name : set_value('name'); ?>" datatype="*2-20" errormsg="长度为2-20个字符" nullmsg="不为空，长度为2-20个字符" sucmsg=" " />
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input type='text' class='form-control' name='class' id="class" value="<?php echo set_value('class') == "" ? $data->class : set_value('class'); ?>" />
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input type='text' class='form-control' name='method' id="method" value="<?php echo set_value('method') == "" ? $data->method : set_value('method'); ?>" />
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				...
				<small class="help-block">选择上级菜单</small>
			</div>
		</div>
		<div class="form-group">
			<label for="sort_order" class="col-md-2 control-label">排序：</label>
			<div class="col-md-8">
				<input type='text' class='form-control' name='sort_order' id="sort_order" value="<?php echo set_value('sort_order') == "" ? $data->sort_order : set_value('sort_order'); ?>" />
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				...
				<small class="help-block">菜单分为导航菜单，权限菜单。</small>
			</div>
		</div>
		<div class="form-group">
