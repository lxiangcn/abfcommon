...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form novalidate="novalidate" method="post" class="simple_form form-horizontal" action="<?php echo site_url('auth/groups/add'); ?>" accept-charset="UTF-8">
			<input type="hidden" name="<?php echo $csrf_name; ?>" value="<?php echo $csrf_token; ?>">
			<div class="form-group">
				<label for="group_name" class="col-md-2 control-label">用户组名称</label>
				<div class="col-md-8">
					<input type='text' class='form-control' name='group_name' id="group_name" value="<?php echo set_value('group_name') == "" ? '' : set_value('group_name'); ?>" datatype="s2-20" errormsg="长度为2-20的英文字符" nullmsg="不为空，长度为2-20的英文字符" sucmsg=" " />
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input type='text' class='form-control' name='description' id="description" value="<?php echo set_value('description') == "" ? '' : set_value('description'); ?>" datatype="*2-20" errormsg="长度为2-20个字符" nullmsg="不为空，长度为2-20个字符" sucmsg=" " />
