...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<?php echo form_open(site_url('archive/channel/edit/'.$id.'/'. $page_no), 'id="validation-form" class="form-horizontal"'); ?>
		<div class="form-group">
			<label for="name" class="col-md-2 control-label">名称</label>
			<div class="col-md-6">
				<input type='text' class='form-control' name='name' id="name" value="<?php echo set_value('name') == "" ? $info->name : set_value('name'); ?>" datatype="*0-50" sucmsg=" " />
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type='text' class='form-control' name='title' id="title" value="<?php echo set_value('title') == "" ? $info->title : set_value('title'); ?>" datatype="*0-50" sucmsg=" " />
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type='text' class='form-control' name='page_size' id="page_size" value="<?php echo set_value('page_size') == "" ? $info->page_size : set_value('page_size'); ?>" datatype="*0-50" sucmsg=" " />
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type='text' class='form-control' name='sort_order' id="sort_order" value="<?php echo set_value('sort_order') == "" ? $info->sort_order : set_value('sort_order'); ?>" datatype="*0-50" sucmsg=" " />
