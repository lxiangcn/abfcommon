...
INSERT INTO `admin` (`id`, `username`, `nickname`, `password`, `email`, `salt`, `gender`, `active`, `logins`, `last_login`, `avatar_remote`, `token`, `created`, `ip_address`, `lost_password_key`, `lost_password_expire`) VALUES
(1, 'admin', NULL, 'b1b1b5e8b00fd4bba028566e0f717b97d3f927c8', 'lxiangcn@qq.com', 'a11679', 'male', 1, 65, 1458651326, '', NULL, 0, NULL, '', 0);
...
INSERT INTO `admin_role` (`user_id`, `group_id`) VALUES
(1, 1);

-- --------------------------------------------------------

--
-- 表的结构 `admin_role_priv`
--

CREATE TABLE IF NOT EXISTS `admin_role_priv` (
  `group_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- 转存表中的数据 `admin_role_priv`
--

INSERT INTO `admin_role_priv` (`group_id`, `menu_id`, `parent_node_id`, `level`) VALUES
(1, 239, 0, 0),
(1, 2, 0, 0),
(1, 3, 0, 0),
(1, 4, 0, 0),
...
INSERT INTO `areas` (`id`, `parent_id`, `name`, `type`) VALUES
(1, 0, '中国', 0),
(2, 1, '北京', 1),
(3, 1, '安徽', 1),
(4, 1, '福建', 1),
...
INSERT INTO `category` (`id`, `channel_id`, `parent_id`, `name`, `created`, `sort_order`, `published`, `sub_count`, `mapping`) VALUES
...
INSERT INTO `channel` (`id`, `name`, `title`, `page_size`, `sort_order`, `created`) VALUES
...
INSERT INTO `configs` (`tag`, `value`, `comment`) VALUES
...
INSERT INTO `groups` (`id`, `group_name`, `description`, `published`) VALUES
(1, 'admin', '管理员', 1),
(2, 'members', '一般用户', 1),
(3, 'test', '演示用户', 1);
...
INSERT INTO `member` (`id`, `username`, `nickname`, `password`, `email`, `salt`, `gender`, `active`, `remember_code`, `groupid`, `logins`, `last_login`, `avatar_remote`, `token`, `created`, `ip_address`, `lost_password_key`, `lost_password_expire`) VALUES
...
INSERT INTO `member_group` (`user_id`, `group_id`) VALUES
(14, 2),
(15, 2),
(16, 2);
...
INSERT INTO `menus` (`id`, `parent_id`, `name`, `url`, `class`, `method`, `ico`, `level`, `is_menu`, `published`, `is_system`, `sort_order`) VALUES
...
INSERT INTO `navigations` (`id`, `navigation_cat_id`, `name`, `link`, `published`, `parent_id`, `sort_order`, `keywords`, `represent`) VALUES
...
--
-- 表的结构 `navigation_cats`
--

CREATE TABLE IF NOT EXISTS `navigation_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `navigation_cats`
--

INSERT INTO `navigation_cats` (`id`, `cat_key`, `name`, `published`, `descript`, `sub_count`) VALUES
...
INSERT INTO `role` (`id`, `group_name`, `description`, `published`) VALUES
(1, 'admin', '超级管理员', 1),
(2, 'members', '管理员', 1);
