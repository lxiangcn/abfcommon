...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<ul class="note">
			<a data-remote="true" class="btn btn-primary btn-sm" href="<?php echo site_url("auth/group/add/".$page_no); ?>">添加用户组</a>
		</ul>
				...
				<tr>
					...
					<td>
						<div aria-label="small button group" role="group" class="btn-group btn-group-sm">
							<a href="<?php echo site_url('auth/group/edit/' . $v->id . '/' . $page_no); ?>" class="btn btn-primary btn-sm">编辑</a>
							<?php if($v->id != 1):?>
							<a rel="nofollow" data-method="delete" data-confirm="真的要删除吗？" class="btn btn-sm btn-danger" href="<?php echo site_url('auth/group/delete/' . $v->id . '/' . $page_no); ?>">删除</a>
							<?php endif;?>
						</div>
					</td>
				</tr>
