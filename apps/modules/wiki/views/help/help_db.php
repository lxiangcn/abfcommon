...
<pre>
    ...
    设置Map记录到<b>CRM_RELATION</b>表,这里数组$arrLeft和$arrRight数据项一一对应
		...
		<p class="m_tc m_mt25 m_green">
		   <a class="btn btn-primary btn-xs m_mr15" href="<?php echo site_url("wiki/ci")?>">上一章</a>
		   	本章节结束，下一章节将介绍前端相关操作
		   <a class="btn btn-primary btn-xs m_ml15" href="<?php echo site_url("wiki/ui")?>">下一章</a>
		</p>
	</div>
</div>