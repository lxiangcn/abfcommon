...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-03-31 08:38:14
...
(1, 'admin', '系统管理员', 'b1b1b5e8b00fd4bba028566e0f717b97d3f927c8', 'webmaster@orzm.net', 'a11679', 'male', 1, 65, 1459405775, '', '5531571258853599255b79239ac758293b94b9a0', 1426144388, NULL, '', 0);
...
CREATE TABLE `abf_admin_attempts` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `abf_admin_role` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `abf_admin_role`
--
...
CREATE TABLE `abf_admin_role_priv` (
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `abf_member_attempts` (
  `id` int(11) NOT NULL,
  `ip_address` varchar(20) DEFAULT NULL,
  `login` varchar(100) DEFAULT NULL,
  `time` int(11) DEFAULT NULL
...
CREATE TABLE `abf_member_group` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `abf_member_group`
--
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='管理菜单表';
...
--
-- Indexes for table `abf_admin`
--
ALTER TABLE `abf_admin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `abf_admin_attempts`
--
ALTER TABLE `abf_admin_attempts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `login` (`login`);

--
-- Indexes for table `abf_admin_role`
--
ALTER TABLE `abf_admin_role`
  ADD KEY `user_id` (`user_id`) USING BTREE,
  ADD KEY `group_id` (`group_id`) USING BTREE;

--
-- Indexes for table `abf_admin_role_priv`
--
ALTER TABLE `abf_admin_role_priv`
  ADD KEY `group_id` (`group_id`) USING BTREE,
  ADD KEY `node_id` (`menu_id`) USING BTREE;

--
-- Indexes for table `abf_archive`
--
ALTER TABLE `abf_archive`
  ADD PRIMARY KEY (`id`),
  ADD KEY `mapping` (`mapping`),
  ADD KEY `news_cat_id` (`category_id`),
  ADD KEY `published` (`published`),
  ADD KEY `title` (`title`);

--
-- Indexes for table `abf_areas`
--
ALTER TABLE `abf_areas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parent_id` (`parent_id`),
  ADD KEY `type` (`type`);

--
-- Indexes for table `abf_category`
--
ALTER TABLE `abf_category`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parent_id` (`parent_id`),
  ADD KEY `name` (`name`),
  ADD KEY `published` (`published`),
...
--
-- Indexes for table `abf_channel`
--
ALTER TABLE `abf_channel`
  ADD PRIMARY KEY (`id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `abf_configs`
--
ALTER TABLE `abf_configs`
  ADD PRIMARY KEY (`tag`);

--
-- Indexes for table `abf_groups`
--
ALTER TABLE `abf_groups`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `group_name` (`group_name`);

--
-- Indexes for table `abf_links`
--
ALTER TABLE `abf_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `name` (`name`),
  ADD KEY `published` (`published`);

--
-- Indexes for table `abf_member`
--
ALTER TABLE `abf_member`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `abf_member_attempts`
--
ALTER TABLE `abf_member_attempts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `login` (`login`);

--
-- Indexes for table `abf_member_group`
--
ALTER TABLE `abf_member_group`
  ADD KEY `user_id` (`user_id`) USING BTREE,
  ADD KEY `group_id` (`group_id`) USING BTREE;

--
-- Indexes for table `abf_menus`
--
ALTER TABLE `abf_menus`
  ADD PRIMARY KEY (`id`),
  ADD KEY `published` (`published`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `abf_navigations`
--
ALTER TABLE `abf_navigations`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `abf_navigation_cats`
--
ALTER TABLE `abf_navigation_cats`
  ADD PRIMARY KEY (`id`),
  ADD KEY `published` (`published`),
  ADD KEY `mapping` (`descript`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `abf_pages`
--
ALTER TABLE `abf_pages`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `abf_page_cats`
--
ALTER TABLE `abf_page_cats`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parent_id` (`parent_id`),
  ADD KEY `name` (`name`),
  ADD KEY `published` (`published`),
...
--
-- Indexes for table `abf_role`
--
ALTER TABLE `abf_role`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `group_name` (`group_name`);

--
-- Indexes for table `abf_sessions`
--
ALTER TABLE `abf_sessions`
  ADD KEY `abf_sessions_timestamp` (`timestamp`);
...
--
-- 使用表AUTO_INCREMENT `abf_admin`
--
ALTER TABLE `abf_admin`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户id', AUTO_INCREMENT=14;
--
-- 使用表AUTO_INCREMENT `abf_admin_attempts`
--
ALTER TABLE `abf_admin_attempts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
-- 使用表AUTO_INCREMENT `abf_archive`
--
ALTER TABLE `abf_archive`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- 使用表AUTO_INCREMENT `abf_areas`
--
ALTER TABLE `abf_areas`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3409;
--
-- 使用表AUTO_INCREMENT `abf_category`
--
ALTER TABLE `abf_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
-- 使用表AUTO_INCREMENT `abf_channel`
--
ALTER TABLE `abf_channel`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- 使用表AUTO_INCREMENT `abf_groups`
--
ALTER TABLE `abf_groups`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- 使用表AUTO_INCREMENT `abf_links`
--
ALTER TABLE `abf_links`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
-- 使用表AUTO_INCREMENT `abf_member`
--
ALTER TABLE `abf_member`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户id', AUTO_INCREMENT=17;
--
-- 使用表AUTO_INCREMENT `abf_member_attempts`
--
ALTER TABLE `abf_member_attempts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- 使用表AUTO_INCREMENT `abf_menus`
--
ALTER TABLE `abf_menus`
  MODIFY `id` smallint(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=285;
--
-- 使用表AUTO_INCREMENT `abf_navigations`
--
ALTER TABLE `abf_navigations`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
--
-- 使用表AUTO_INCREMENT `abf_navigation_cats`
--
ALTER TABLE `abf_navigation_cats`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- 使用表AUTO_INCREMENT `abf_pages`
--
ALTER TABLE `abf_pages`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- 使用表AUTO_INCREMENT `abf_page_cats`
--
ALTER TABLE `abf_page_cats`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `abf_role`
--
ALTER TABLE `abf_role`
