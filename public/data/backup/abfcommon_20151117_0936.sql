...
CREATE TABLE `abf_menus` (
  ...
  KEY `published` (`published`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=277 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='管理菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `abf_users` VALUES (1,NULL,'admin',NULL,'b1b1b5e8b00fd4bba028566e0f717b97d3f927c8','lxiangcn@qq.com','a11679','male',1,65,1447654444,'','5531571258853599255b79239ac758293b94b9a0',1426144388,NULL,'',0),(11,'owwoat21RMtLCrRx9zuXg-_Q4W_c','owwoat21RMtLCrRx9zuXg-_Q4W_c','王一二','243f54a0457e815dda58673079eddf88d9d3034a','1447311987@weixin.com','f15259','male',1,0,1447311987,'',NULL,1447311987,'219.133.40.15','',0),(10,'owwoat1nLvm_WP95vfeA2iTgkzEQ','owwoat1nLvm_WP95vfeA2iTgkzEQ','栁祥','a8501660040f72d01caf99e9c74bcc5858ce04e1','1447230399@weixin.com','6bfb64','male',1,0,1447230399,'',NULL,1447230399,'123.103.8.86','',0),(12,'owwoat_N8oagcAktGJT5iY4OCzNU','owwoat_N8oagcAktGJT5iY4OCzNU','潘智胜','029dc7658692ade700606560e886bcabbd94285e','1447393724@weixin.com','14d13b','male',1,0,1447393724,'',NULL,1447393724,'14.17.37.69','',0);
...
INSERT INTO `abf_wechat_settings` VALUES ('access_token','001Ol6dgTYE2aOMsCDIRwk2EeZ0PI5sTvjOILjZ1zF6IidKThnOSri8dkAa162RwRKlNSe16tH6kNIe9fHipbLzlawdsjTlcE13v2mSiULwZKVfAHAGRC'),('access_token_expire_time','1447430691'),('appid','wx7b8cd3c4529da6b9'),('appsecret','52fd102e709cb55bb5d9ca2101935b0e'),('cmd_expire_time','300'),('cmd_sign','#'),('help_keyword','亲，您的问题不够详细哟，我不能明白您的意思～'),('pause_notice','系统维护中，请稍后访问'),('run_mode','pause'),('token','sitecms'),('event_cmd_prefix','cmd_'),('encodingaeskey',''),('subscribetext','欢迎关注，基础应用框架开源框架期待你的加入，贡献。');
...
-- Dump completed on 2015-11-17  9:36:52
