...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form novalidate="novalidate" method="post" class="simple_form form-horizontal" action="<?php echo site_url('dashboard/navigation/edit/' . $data->id . '/' . $page_no); ?>" accept-charset="UTF-8">
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<div id='outurl'>
						<input type='text' class='form-control link' name='link' id="link" value="<?php echo set_value('link') == "" ? $data->link : set_value('link'); ?>" datatype="*" nullmsg="请输入URL" sucmsg=" " />
		                <?php if (form_error('url')): ?><?php echo form_error('url', '<small class="help-block Validform_checktip Validform_wrong">', '</small>'); ?><?php else: ?><small class="help-block Validform_checktip Validform_wrong">如果是站外链接，请直接输入网址，注意要加上http://,链接首页，请输入"/"</small><?php endif; ?>
		            </div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-md-offset-2 col-md-9">
					<button class="btn btn-primary" name="commit" type="submit">更新导航</button>
				</div>
			</div>
		</form>
	</div>
